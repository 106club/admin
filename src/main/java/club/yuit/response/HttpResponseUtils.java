...
import static club.yuit.response.HttpStatusAndMsg.exs;
...
public final class HttpResponseUtils {
     ...
     * --------------------------ListResponse-------------------------------------------------
     */
    public static <T> ListResponse listResponse(int status, Items<T> items) {
        return listResponse(status, null, items);
    }

    public static <T> ListResponse listResponse(int status, String msg, Items<T> items) {
    ...
    public static <T> ListResponse successListResponse(Items<T> items) {
        return listResponse(200, items);
    }

    public static <T> ListResponse successListResponse(String msg, Items<T> items) {
